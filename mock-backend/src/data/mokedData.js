const products = [
  ...
  },
  {
    ...
    description:
      'Screen: 13.4" FHD+ Touchscreen, 1920x1200 / Intel Core i7-1165G7 / RAM 16 GB / 512 GB SSD / Wi-Fi 6 / Bluetooth 5.1 / Windows 11 Home / 52 Wh battery',
    status: "AVAILABLE",
    tags: ["category:computer"],
    image:
  ...
  },
  {
    ...
    description:
      'Screen: 6.7" LTPO AMOLED, 3120x1440 / Google Tensor G2 / Main Triple Camera: 50 MP + 48 MP + 12 MP, Front Camera: 11.1 MP / RAM 12 GB / 128 GB internal storage / 3G / LTE / 5G / GPS / GLONASS / Dual SIM support (Nano-SIM and eSIM) / Android 13 / 5000 mAh',
    status: "AVAILABLE",
    tags: ["category:mobile"],
    image:
      "https://j65jb0fdkxuua0go.public.blob.vercel-storage.com/phone_1-QodrkqNjm6MWrKqg9ixBBMMfFU40X7.jpg",
